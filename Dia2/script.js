...
// Munu principal de los campers
function menuCampers() {
    console.log("");
    console.log(
        "/////////////////////////////////////////////////\n" +
        "------------ BIENVENIDO CAMPER-------------------\n" +
...
// Opciones del menu de la opcion 1 del camper
...
// Opciones del menu de la opcion 3 del camper
function menuCampersOpc3() {
    console.log("");
    console.log(
        "------------ BIENVENIDO CAMPER-------------------\n" +
        "1). Cambiar dirección..\n" +
...
// Opciones del menu de la opcion 3 del trainer
...
// Menu principal del coordinador 
    ...
    for (const i of campuland[0]["Campers"]){
        if (user == i["user"]["login"]){
            ...
            while (campers == true){
                ...
                menuCampers()
                opcMenuCamper = prompt("Ingresa una opcion de las que aparecen en pantalla")
                ...
                if(opcMenuCamper == 2){
                    ...
                    while (bol1 == true){
                        ...
                        for (const r of campuland[0]["Trainers"]) {
                            if (newUser1 == r["user"]["login"]) {
                                cont = cont + 1
                            }
                        }
                        
                        if (newUser1 == campuland[0]["Coordinador"][0]["user"]["login"]) {
                            cont8 = cont8 + 1
                        }
                    ...
                    i["user"]["login"] = newUser1

                    newPass1 = prompt("¿Ingrese la nueva contraseña?\n")

                    i["user"]["contraseña"] = newPass1
                }
                menuCampers()
                opcMenuCamper = prompt("Ingresa una opcion de las que aparecen en pantalla")

                if (opcMenuCamper == 3){
                    let confirmacion1 = "si";
